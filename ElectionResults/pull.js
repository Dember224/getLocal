...
function getStateAndLevel(label) {
    ...
    else if(label.indexOf(state + ' state executives') == 0 || label.indexOf(state + ' ballot measures') == 0) return null; //If the search pics up state execs eg. governors attorney generals etc. or ballot measures just skip the record for now. 
